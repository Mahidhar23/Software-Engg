...
html_file_path = r"D:\EXP2_1471\model.html"
...
try:
    ...
    a, b, c = 1, -3, 2  # Example hard-coded values
    ...
    with open(r"D:\EXP2_1471\input_single.txt", "r") as file:
    ...
    with open(r"D:\EXP2_1471\input.txt", "r") as file:
        for line in file:
